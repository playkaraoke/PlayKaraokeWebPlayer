...
function setup() {
  ...
  let listener = null;
  win.BroadcastChannel = class { postMessage() {} addEventListener(_, fn) { listener = fn; } };
  const yt = { t: 0, playing: false, seeks: [], async load() {}, play() { this.playing = true; }, pause() { this.playing = false; },
