...
const TRANSLATIONS = {
  en: {
    ...
    ambient_source_builtin: 'App songs',
    ambient_source_custom: 'My songs',
    ambient_choose_folder: 'Choose folder',
    ambient_change_folder: 'Change folder',
    ambient_reconnect_folder: 'Reconnect',
    ambient_no_folder: 'No folder chosen — playing the app songs.',
    ambient_folder_info: '{name} · {count} songs',
    ambient_folder_empty: '{name} has no audio files — playing the app songs.',
    ambient_folder_needs_permission: 'Allow access to "{name}" again.',
    ...
    library_source_online: 'YouTube',
    online_search_btn_title: 'Search YouTube',
    online_placeholder: 'Search karaoke on YouTube… (Enter)',
    online_hint: 'Search karaoke videos on YouTube. Type and press Enter. <strong>No key change</strong> on YouTube songs.',
    online_searching: 'Searching…',
    online_no_results: 'Nothing found online.',
    online_err_not_configured: 'Online search is not set up yet.',
    online_err_offline: 'No internet connection — online search is unavailable. Use Devices.',
    online_err_quota: "Today's online search limit was reached. Try again tomorrow, or use Devices.",
    online_err_all_keys_exhausted: "Today's online search limit was reached. Try again tomorrow, or use Devices.",
    online_err_network: 'Could not reach the online search. Check your connection and try again.',
    online_err_server: 'Online search failed. Try again in a moment.',
    online_badge: 'YOUTUBE',
    online_add_title: 'Add to queue',
    youtube_err_unavailable: 'This YouTube video is unavailable (removed, private or blocked from playing here).',
    youtube_err_load: 'Could not load the YouTube player. Check your internet connection.',
    pitch_unavailable_online: 'Key change is not available for online (YouTube) songs',
  ...
  pt: {
    ...
    ambient_source_builtin: 'Músicas do app',
    ambient_source_custom: 'Minhas músicas',
    ambient_choose_folder: 'Escolher pasta',
    ambient_change_folder: 'Trocar pasta',
    ambient_reconnect_folder: 'Reconectar',
    ambient_no_folder: 'Nenhuma pasta escolhida — tocando as músicas do app.',
    ambient_folder_info: '{name} · {count} músicas',
    ambient_folder_empty: '{name} não tem arquivos de áudio — tocando as músicas do app.',
    ambient_folder_needs_permission: 'Permita de novo o acesso a "{name}".',
    ...
    library_source_online: 'YouTube',
    online_search_btn_title: 'Buscar no YouTube',
    online_placeholder: 'Buscar karaokê no YouTube… (Enter)',
    online_hint: 'Busca vídeos de karaokê no YouTube. Digite e aperte Enter. <strong>Sem ajuste de tom</strong> nas músicas do YouTube.',
    online_searching: 'Buscando…',
    online_no_results: 'Nada encontrado online.',
    online_err_not_configured: 'A busca online ainda não foi configurada.',
    online_err_offline: 'Sem internet — a busca online está indisponível. Use Dispositivos.',
    online_err_quota: 'O limite de buscas online de hoje acabou. Tente amanhã, ou use Dispositivos.',
    online_err_all_keys_exhausted: 'O limite de buscas online de hoje acabou. Tente amanhã, ou use Dispositivos.',
    online_err_network: 'Não foi possível acessar a busca online. Confira a conexão e tente de novo.',
    online_err_server: 'A busca online falhou. Tente de novo em instantes.',
    online_badge: 'YOUTUBE',
    online_add_title: 'Adicionar à fila',
    youtube_err_unavailable: 'Este vídeo do YouTube está indisponível (removido, privado ou bloqueado para tocar aqui).',
    youtube_err_load: 'Não foi possível carregar o player do YouTube. Confira a conexão com a internet.',
    pitch_unavailable_online: 'Ajuste de tom indisponível para músicas online (YouTube)',
