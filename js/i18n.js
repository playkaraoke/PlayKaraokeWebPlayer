...
const TRANSLATIONS = {
  en: {
    ...
    online_hint: 'Search karaoke videos on YouTube. Type and press Enter. <strong>No key change</strong> on online songs.',
  ...
  pt: {
    ...
    online_hint: 'Busca vídeos de karaokê no YouTube. Digite e aperte Enter. <strong>Sem ajuste de tom</strong> nas músicas online.',
